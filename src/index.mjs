...
const PRODUCT = {
  "repo": "gainsight-customer-health-signal-board",
  "vendor": "Gainsight",
  "title": "customer health signal board",
  "domain": "Customer Success",
  "audience": "Customer success leaders, revenue strategists, renewals teams, and SaaS operators",
  "problem": "Customer health scores often fail to explain which risks are real, which accounts are recoverable, and where expansion is blocked.",
  "workflow": "The product ties health score movement, adoption gaps, renewal posture, playbook ownership, and executive escalation into one lane.",
  "business": "Leaders can decide where to save revenue, where to invest in expansion, and where churn risk is already priced in.",
  "technical": "Synthetic customer-success lanes are scored deterministically and rendered into a static signal board.",
  "integration": "Gainsight health scores, CTAs, adoption metrics, renewals, playbooks, and escalation notes.",
  "keywords": [
    "Gainsight",
    "customer health",
    "renewal risk",
